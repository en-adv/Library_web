<div id="content">
	...
	<p id="tombol-tambah-container2"><a href="index.php?p=anggota-input" class="tombol">Tambah Anggota</a>
	<p id="tombol-tambah-container"><a href="pages/cetak.php" class="tombol">Cetak Data</a>
	<?php } ?>
</div>