<div id="content">
	...
	<p id="tombol-tambah-container2"><a href="index.php?p=buku-input" class="tombol">Tambah Buku</a>
	<p id="tombol-tambah-container"><a href="pages/cetak2.php" class="tombol">Cetak Data</a>
	<?php } ?>
</div>